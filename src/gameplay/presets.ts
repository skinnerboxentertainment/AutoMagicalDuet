...
export const PRESETS: Record<string, MovementConfig> = {
  "Fixed (Retro)": {
    ...
    elasticity: 0.1, squashRecoveryRate: 20, coyoteTime: 0.1, jumpBuffer: 0.1,
  },
  Balanced: {
  ...
  Heavy: {
    ...
    elasticity: 0.3, squashRecoveryRate: 10, coyoteTime: 0.1, jumpBuffer: 0.1,
  },
  Light: {
    ...
    elasticity: 1.5, squashRecoveryRate: 12, coyoteTime: 0.15, jumpBuffer: 0.15,
  },
  Floaty: {
    ...
    elasticity: 0.5, squashRecoveryRate: 25, coyoteTime: 0.15, jumpBuffer: 0.15,
  },
  Snappy: {
    ...
    elasticity: 1.2, squashRecoveryRate: 8, coyoteTime: 0.08, jumpBuffer: 0.08,
  },
};
